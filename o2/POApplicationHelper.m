...
+(NSString*)settingsPath{
    return [NSString stringWithFormat:@"%@/Library/Preferences/%@", NSHomeDirectory(), @"xc.lzsxcl.o2.Split.plist"];
}
...
+(NSString*)authorizationPath{
    return [NSString stringWithFormat:@"%@/Library/Preferences/%@", NSHomeDirectory(), @"xc.lzsxcl.o2.SplitApp.plist"];
}
