...
#define SETUP_HIDE_BUTTON() ({\
	...
	NSInteger xOffset = [([prefs objectForKey:@"xOffset"] ?: @300) intValue];\
	NSInteger yOffset = [([prefs objectForKey:@"yOffset"] ?: @600) intValue];\
	hideButton.translatesAutoresizingMaskIntoConstraints = NO;\
	hideButton.showsTouchWhenHighlighted = YES;\
